...
xb = pm_coef["b0"] + age * pm_coef[1] + loud * pm_coef[3]
(predicted = 1.0 / (1.0 + exp(-xb)) )

# baseline is high ome, coherent sound
# predicting for 60 months, high ome, coherent at 50 db
age = 60
omelow = 0
incoherent = 0
loud = 50
